...
import Task1.Problem3point2.EmployeeDetailAggregation;
import Task1.Problem3point2.EmployeeDetailComposition;
import Task1.Problem3point2.Human;
...
//        };
        ...
        EmployeeDetailAggregation aggregation =new EmployeeDetailAggregation();
        ...
        //Q3.2.2: Compose class with Aggregation
        System.out.println("\n\n\t\t\t Q3.2.2: Compose class with Composition ");
        EmployeeDetailComposition compositon =new EmployeeDetailComposition();
        compositon.setId(123);
        compositon.setName("Composition");
        compositon.setAddress("12345","Norway Glassglow street");
        System.out.println(compositon);
       Human human = new Human("Brown eyes","Breathe");
